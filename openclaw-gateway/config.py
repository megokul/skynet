...
# Quality gates
STRICT_QUALITY_GATES_ENABLED: bool = _b(
    "SKYNET_STRICT_QUALITY_GATES_ENABLED", True
)
STRICT_QUALITY_GATES_DEFAULT_PROFILE: str = _s(
    "SKYNET_STRICT_QUALITY_GATES_DEFAULT_PROFILE", "strict"
).lower()
STRICT_QUALITY_GATES_FIX_RETRIES: int = _i(
    "SKYNET_STRICT_QUALITY_GATES_FIX_RETRIES", 1
)
...
CODING_DEFAULT_PROFILE: str = _s(
    "SKYNET_CODING_DEFAULT_PROFILE", "codex_primary"
).lower()
CODING_FORCE_PRIMARY_FOR_ALL: bool = _b(
    "SKYNET_CODING_FORCE_PRIMARY_FOR_ALL", True
)
CODING_FALLBACK_CHAIN: str = _s(
    "SKYNET_CODING_FALLBACK_CHAIN", "codex,claude_ollama,cline"
).lower()
PLANNER_PRIMARY_AGENT: str = _s(
    "SKYNET_PLANNER_PRIMARY_AGENT", "codex"
).lower()
PLANNER_CODEX_TIMEOUT_SECONDS: int = _i(
    "SKYNET_PLANNER_CODEX_TIMEOUT_SECONDS", 120
)
MILESTONE_CODEX_TIMEOUT_SECONDS: int = _i(
    "SKYNET_MILESTONE_CODEX_TIMEOUT_SECONDS", 120
)
...
CODING_AGENT_MAX_WAIT_SECONDS: int = _i(
    "SKYNET_CODING_AGENT_MAX_WAIT_SECONDS", 900
)
...
_CLAUDE_OLLAMA_MODEL_DEFAULT = _s(
...
CLAUDE_OLLAMA_AUTH_TOKEN: str = _s(
    "SKYNET_CLAUDE_OLLAMA_AUTH_TOKEN", "ollama"
)
...
CLAUDE_OLLAMA_MIN_CONTEXT: int = _i(
    "SKYNET_CLAUDE_OLLAMA_MIN_CONTEXT", 64000
)
